  ...
  for i = 1:size([u, v], 1)
      ...
      if u(i) > v(i)
          ...
          elseif strcmp(TransName, 'MHSwendsenWang2')
              ...
              %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
              mincard = min(edge_factor.card);
              assignments = repmat((1:mincard)', 1, 2);
              indices = AssignmentToIndex(assignments, edge_factor.card);
              q_ij = sum(edge_factor.val(indices)) / sum(edge_factor.val);
              %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
          else
