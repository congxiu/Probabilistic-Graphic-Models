...
for i = 1:2:numAlleles * numAlleles * 2
    assignment = IndexToAssignment(i, phenotypeFactor.card);
    idx = allelesToGenotypes(assignment(2), assignment(3));
    phenotypeFactor.val(i) = alphaList(idx);
    phenotypeFactor.val(i + 1) = 1 - alphaList(idx);
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%